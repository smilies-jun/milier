...
@interface ThreeYetViewController (){
...
@implementation ThreeYetViewController
...
-(void)getNetworkData:(BOOL)isRefresh
{
    ...
    Bottomurl = [NSString stringWithFormat:@"%@/productOrderRepayments?page=%d&rows=20&userId=%@&state=3",HOST_URL,page,userID];
    if (page == 1) {
