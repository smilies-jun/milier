//
//  SevenDinQiViewController.m
//  milier
//
//  Created by amin on 2017/11/23.
...
#import "SecondTableViewCell.h"
#import "ProuctModel.h"
@interface SevenDinQiViewController (){
...
@implementation SevenDinQiViewController
...
-(void)getNetworkData:(BOOL)isRefresh
{
    ...
    if (isRefresh) {
        url = [NSString stringWithFormat:@"%@?page=1&rows=20&userId=%@&productCategoryId=0&state=10",PRODUCTO_RDERS_URL,userID];
        
    }else{
        url = [NSString stringWithFormat:@"%@?page=%d&rows=20&userId=%@&productCategoryId=0&state=10",PRODUCTO_RDERS_URL,page,userID];
