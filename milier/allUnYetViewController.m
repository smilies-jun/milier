...
@interface allUnYetViewController (){
...
@implementation allUnYetViewController
...
-(void)getNetworkData:(BOOL)isRefresh
{
   ...
   if (isRefresh) {
    ...
    Bottomurl = [NSString stringWithFormat:@"%@/productOrderRepayments?page=%d&rows=20&userId=%@&state=0",HOST_URL,page,userID];
    if (page == 1) {
