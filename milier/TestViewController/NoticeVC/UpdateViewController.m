...
-(void)getNetworkData:(BOOL)isRefresh
{
    ...
    NSString *url;
    if (isRefresh) {
        url = [NSString stringWithFormat:@"%@/notices?page=1&rows=10&categoryId=4",HOST_URL];
    }else{
        url = [NSString stringWithFormat:@"%@/notices?page=%d&rows=10&categoryId=4",HOST_URL,page];
