...
- (UITableView *)tableView{
    ...
    if (!_tableView) {
        _tableView = [[MyTableView alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height- 64-44-150) style:UITableViewStylePlain];
